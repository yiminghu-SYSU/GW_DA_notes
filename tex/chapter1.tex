...
\begin{equation}
\nabla ^2 \mathbf {E} - \varepsilon_{0} \mu_0 \frac {\partial^2 \mathbf {E} }{\partial^2 t}= 0
\end{equation}
...
\begin{equation}
\left[ \nabla ^2  - \frac{1}{c^2}\frac{\partial^2 }{\partial^2 t} -\frac{2}{c^2}(\mathbf{v}\cdot \nabla)\frac{\partial }{\partial t} - \frac{1 }{c}(\mathbf{v}\cdot \nabla)(\mathbf{v}\cdot \nabla)\right]\phi= 0
\end{equation}
