...
考虑一个测试粒子，遵从测地线方程（公式\ref{eq:geodesics}），故此，其加速度为
...
我们考虑有两个检验粒子，其相互之间以矢量 $\xi^\alpha$间隔，且以4-速度$u^\alpha$运动。
假设两个粒子的空间间隔远小于引力波的特征波长，那么可以得到两个粒子的间隔由测地线偏离（geodesic deviation）公式给出
